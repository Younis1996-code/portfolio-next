      ...
      <Container className="space-y-10 lg:space-y-20 mt-23 md:mt-25 xl:mt-33">
        ...
        <div className="relative w-full mx-auto">
          ...
          <input
            ...
            className="bg-Grey-10/60 w-full py-2 lg:py-4 rounded-md lg:rounded-lg xl:rounded-xl pl-4 lg:pl-8 focus:outline-none focus:border focus:border-Green-65 placeholder:opacity-50 text-[3.3333vw]/[150%] md:text-[2.5vw]/[150%] lg:text-[1.8vw]/[150%] xl:text-[1.5vw]/[150%] text-Grey-60 pr-8 lg:pr-16"
          />
          <LuSearchCode
            aria-hidden="true"
